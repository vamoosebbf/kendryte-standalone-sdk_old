...
{
    gpiohs_set_drive_mode(DCX_GPIO_HS_NUM, GPIO_DM_OUTPUT);
    gpiohs_set_pin(DCX_GPIO_HS_NUM, GPIO_PV_HIGH);
}

static void set_dcx_control(void)
{
    gpiohs_set_pin(DCX_GPIO_HS_NUM, GPIO_PV_LOW);
}
...
{
    gpiohs_set_drive_mode(RST_GPIO_HS_NUM, GPIO_DM_OUTPUT);
    gpiohs_set_pin(RST_GPIO_HS_NUM, GPIO_PV_LOW);
    usleep(100000);
    gpiohs_set_pin(RST_GPIO_HS_NUM, GPIO_PV_HIGH);
    usleep(100000);
}
